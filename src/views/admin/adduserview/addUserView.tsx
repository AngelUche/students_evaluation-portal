...
function AddUserView() {
    ...
    function submitEditedProfile() {
        ...
        setCurrentUser((currentUser: UserProfileInterface) => {
            return {
                ...currentUser,
                classDesignation: selectedClass,
        ...
        alert(
            `User: ${currentUser.firstName} Position: ${currentUser.position} has been saved`
        );
    }
    ...
    return (
        <>
            <form
                className="max-w-[900px] mx-auto mt-6 px-6 py-[30px]"
                        ...
                        <div className="py-1 max-h-[45vh] flex flex-col gap-y-2 overflow-y-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                                ...
                                <div className="flex flex-col basis-full">
                                    ...
                                    <input
                                        className={`p-2 text-gray-700 text-[14px] rounded-sm border-[1px] border-gray-300 bg-formFieldBg focus:border-blue-500 outline-none `}
                                        type="text"
                                        id="position"
                                        ...
                                        >
                                            ...
                                            {classData.map((classData) => {
                                                return (
                                                    <option
                                                        key={classData.id}
                                                        value={classData.classDesignation}
                                                    >
