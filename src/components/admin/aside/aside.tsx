        ...
        <>
            <aside className="w-full h-full flex flex-col overflow-y-auto bg-[#f8f8f8] z-10">
                ...
                <NavLink to="" end
                    ...
                    <span className="font-bold text-xl text-[#2b2a2a9f]">Home</span>
                </NavLink>
                <NavLink to="userprofile"
                    className={({ isActive }) => `p-4 pl-5 flex justify-start items-center gap-9 ${isActive ? "bg-[#bfbff8] px-5 border-l-4 border-l-[#0d0de2bd]" : undefined}`}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="25" height="25"><path d="M12 2.5a5.25 5.25 0 0 0-2.519 9.857 9.005 9.005 0 0 0-6.477 8.37.75.75 0 0 0 .727.773H20.27a.75.75 0 0 0 .727-.772 9.005 9.005 0 0 0-6.477-8.37A5.25 5.25 0 0 0 12 2.5Z"></path></svg>
                    <span className="font-bold text-xl text-[#2b2a2a9f]">User Profiles</span>
                </NavLink>
                <NavLink to="adduser"
                    className={({ isActive }) => `p-4 pl-5 flex justify-start items-center gap-9 ${isActive ? "bg-[#bfbff8] px-5 border-l-4 border-l-[#0d0de2bd]" : undefined}`}>
                    ...
                    <span className="font-bold text-xl text-[#2b2a2a9f]">Add User</span>
                </NavLink>
                <NavLink to="viewresult"
                    ...
                    <span className="font-bold text-xl text-[#2b2a2a9f]">View Results</span>
                </NavLink>
                <NavLink to="broadcastmail"
                    ...
                    <span className="font-bold text-xl text-[#2b2a2a9f]">Broadcast Mail</span>
                </NavLink>
                <NavLink to="passwordreset"
                    ...
                    <span className="font-bold text-xl text-[#2b2a2a9f]">Reset Password</span>
                </NavLink>
            </aside>
        </>
    )
