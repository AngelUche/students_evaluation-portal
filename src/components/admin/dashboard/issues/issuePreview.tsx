...
function IssuesPreview({ title, message }: IssuesPreviewProps) {
    return (
        <>
            <div className="px-5 py-2  h-[200px]  flex flex-col justify-start border-l-[3px] border-l-red-500 cursor-pointer bg-[#faf0f0]">
