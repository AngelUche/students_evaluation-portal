...
function UserProfileFormHeader({ userImage, userName, userFirstName, userLastName, userPosition, userId }: UserProfileFormHeaderProps) {
    return (
