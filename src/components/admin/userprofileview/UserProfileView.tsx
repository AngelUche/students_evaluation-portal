...
function UserProfileView() {
  const { showUserProfile, toggleShowUserProfile } = useContext(
    ...
    <div className="h-full max-w-[900px] mx-auto px-6 py-[30px]">
      ...
      <div className="relative shadow-md py-5 px-4 bg-[#fffcfc]">
        ...
        <div className="absolute  top-5 right-5 cursor-pointer">
          {editProfileStatus ? (
            <div
              className="text-red-500 hover:shadow-lg hover:text-red-700"
          ...
          <div className="py-1 flex flex-col gap-y-2 max-h-[51vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
              ...
              <div className="flex flex-col">
                ...
                <input
                  className={`p-2 text-gray-700 text-[14px] rounded-sm ${
                    editProfileStatus
                      ? "border-[1px] border-gray-300 bg-editFormFieldBg focus:border-blue-500 outline-none"
                      : "bg-formFieldBg"
                  } `}
                  type="text"
              ...
              <div className="flex flex-col">
                ...
                <input
                  ...
                  defaultValue={currentUser?.otherName}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
              ...
              <div className="flex flex-col justify-end basis-full">
                ...
                <select
                  id="gender"
                  className={`p-[10px] text-gray-700 text-[14px] rounded-sm ${
                    editProfileStatus
                      ? "border-[1px] border-gray-300 bg-editFormFieldBg focus:border-blue-500 outline-none"
                      : "bg-formFieldBg"
                  } `}
                ...
                >
                  <option value={currentUser.gender} selected>
                    {currentUser.gender}
                  </option>
              ...
              {currentUser?.classDesignation && (
                <div className="flex flex-col basis-full">
                  ...
                  <input
                    ...
                    type="text"
                    id="designation"
                    defaultValue={currentUser?.classDesignation}
                    value={currentUser?.classDesignation}
                    disabled={!editProfileStatus}
                  />
                </div>
              )}
      ...
      <div className="mt-5 flex justify-center">
        {editProfileStatus ? (
          ...
          <button
            className="w-full max-w-[300px] mx-auto rounded uppercase py-3 bg-[blue] hover:bg-[#0202c5] hover:shadow-xl text-white font-mono font-bold"
