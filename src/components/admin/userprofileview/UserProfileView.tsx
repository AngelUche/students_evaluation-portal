          ...
          <div className="py-1 flex flex-col gap-y-2 max-h-[50vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
              ...
              <div className="flex flex-col">
                ...
                <input
                  className="p-2 bg-formFieldBg text-gray-700 text-[14px] rounded-sm focus:border-[1px] focus:border-blue-300 focus:outline-none"
                  type="text"
              ...
              {User?.classDesignation && (
                <div className="flex flex-col basis-full">
                  ...
                  <input
                    ...
                    type="text"
                    id="designation"
                    defaultValue={User?.classDesignation}
                    value={User?.classDesignation}
                  />
                </div>
              )}
            </div>
...
export { UserProfileView };
>>>>>>> 3a9e9bfd02355069fa464d3f4e8724e38e6ed69f
